...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
     ...
     * @param newTopic     新主题
     * @param queueNum     队列数量
     * @param topicSysFlag 主题系统标记
     * @throws MQClientException 消息客户端异常
     */
    ...
    /**
     * 检查配置,如果消费者组为空，抛出异常;如果消费者组等于默认消费者组，抛出异常;如果消息模型为空，抛出异常;如果消费点为空，抛出异常;如果无消费的时间戳，抛出异常
     *
     * @throws MQClientException mqclient例外
     */
